...
import pkg from "./o-data-grid-pro/package.json" assert { type: "json" };
...
export default [
    {
        ...
        plugins: [
            del({ targets: "o-data-grid-pro/build/*"}),
            typescript(),
        ],
    ...
    {
        input: "./o-data-grid-pro/build/build/o-data-grid-pro/src/index.d.ts",
        output: [
            {
